...
The gRPC-based service is limited to data migration operations, thus the XrootdSSI-based frontend is needed to provide admin-tool functionality\footnote{There is an ongoing development to migrate the admin interface to gRPC-based frontend. This activity is not directly correlated to dCache with CTA integration}.
...
\section{Migration from existing tape software}
\label{migraion}
