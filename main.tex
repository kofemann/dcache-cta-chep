...
\abstract{%
  ...
  CTA as a main alternative to commercial HSM systems. dCache has an extensible tape interface that allows connectivity almost to any tape system. Together with the CERN Tape Archive developers, the storage team at DESY works on seamless integration of CTA into dCache.
}
%
\maketitle
%
...
large numbers of disk servers and transparent data migration to and from an archival storage.
